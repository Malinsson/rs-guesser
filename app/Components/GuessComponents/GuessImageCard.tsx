    ...
    return (
        ...
        >
            <div className="h-38 md:h-40 lg:h-46 w-full px-4 md:px-6 bg-[url(/images/styling/button_large.gif)] bg-size-[100%_100%] bg-no-repeat bg-center flex flex-col items-center justify-center">
                ...
                />
                <div className={`mt-4 h-8 md:h-9 lg:h-10 w-full flex flex-col items-center align-middle rounded-md inset-shadow-sm inset-shadow-green-900 border-2 border-bordergrey transition-all duration-300 ${checkGuessState(guessState)} p-1 text-center`}>
